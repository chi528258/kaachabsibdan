const motherTypes = {
  ...
  1: {
    ...
    name: "引っ張る母ちゃん",
    description:
      "「大丈夫！私についてきな！」と家族を引っ張っていく頼れる母ちゃん。決断力があり、子どもの背中を押すことが得意です。",
    mother:
      "家族を守ろうとする気持ちが強く、何かあったときには先頭に立って動くタイプ。",
    child:
      "「やってみな！」と挑戦する勇気を与えるのが得意。ついつい先回りしてしまうことも。",
    angry:
  ...
  2: {
    ...
    angry:
      "我慢してしまい、後から一気に感情が出てしまうことも。",
    charm:
      "優しさと共感力。子どもが安心して戻ってこられる場所になれる人です。"
  },
  ...
  5: {
    ...
    angry:
      "同じことを何度も言うのが苦手。限界が来ると突然爆発することも。",
    charm:
      "柔軟さと行動力。子どもに「自由に生きていい」と伝えられます。"
  },
